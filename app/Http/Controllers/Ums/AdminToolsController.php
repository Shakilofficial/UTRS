...
class AdminToolsController extends Controller
{
    ...
    {
        $approved = Requisition::where('status', 'Approved By Administration')->orWhere('status', 'Approved By Vice Chancellor')->orderBy('created_at', 'desc')->get();
    ...
    public function admin_confirm_requisition(Request $request)
    {
        ...
        $user_message = "Congratulations, {$user_name} ! Your vehicle requisition is approved.\n \nRequisition Details- \nPickup: ".$pickup."\nDestination: ".$destination."\nDriver: ".$driver_name."\nPhone: ".$driver_phone;
        $driver_message = "Hello Mr. {$driver_name}. You have been assigned to a new requisition.\n \nRequisition Details- \nPickup: ".$pickup."\nDestination: ".$destination."\nTraveller: ".$user_name."\nDesignation: ".$user_designation."\nPhone: 0".$user_phone;

        $url = "https://bulksmsbd.net/api/smsapimany";
        $api_key = "ephJPDUGpEWK64JaE2UE";
