...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Shakil" name="author" />
        <!-- App favicon -->
    ...
    <body data-bs-spy="scroll" data-bs-target="#topnav-menu" data-bs-offset="60">
        ...
        <nav class="navbar navbar-expand-lg navigation fixed-top sticky" style="background: #fff;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    ...
                    <div class="my-2 ms-lg-2">
                        @if(Auth::user())
                            <a href="@if(Auth::user()->hasRole('Administration')) {{ route('administrator.dashboard') }} @elseif(Auth::user()->hasRole('Chairman')) {{ route('chairman.dashboard') }} @elseif(Auth::user()->hasRole('Teacher')) {{ route('teacher.dashboard') }} @endif" class="btn btn-dark w-xs">Go To Dashboard</a>
                        @else
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="mb-4">
                            ...
                            <img src="{{ config('core.image.default.logo') }}" style="background: #fff;border-radius: 2px; width: 140px; height: 120px;" class="editPro" alt="" height="100">
                        </div>
    
                        <p class="mb-2"><script>document.write(new Date().getFullYear())</script> © MBSTU {{ config('app.name') }}</p>
                        <p>Crafted with <i class="mdi mdi-heart text-danger"></i> by Shakil</p>
                    </div>
