                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-7">
                                                <div class="text-center">
                                                    ...
                                                    <h4 class="mb-3"><i class="bx bxs-quote-alt-left text-primary h1 align-middle me-3"></i><span class="text-primary">{{ \App\Models\User::where('approved_at', '!=', null)->count()  + 2 }}</span>+ Current Users</h4>
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="mt-4 text-center">
                                                <p>Don't have an account ? <a href="{{ route('register') }}" class="fw-medium text-primary"> Sign Up here </a> </p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> {{ config('app.name') }} <b>-</b>  Crafted with <i class="mdi mdi-heart text-danger"></i> by Team</p>
                                    </div>
                                </div>
