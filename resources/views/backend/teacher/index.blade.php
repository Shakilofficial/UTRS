            ...
            {{-- <div class="alert bg-danger bg-gradient text-white" style="text-align: center;font-weight: 550; margin-bottom: 40px;" role="alert">
               ...
               <div class="alert alert-dismissible alert-warning" style="text-align: center; margin-bottom: 40px;padding: 4px;" role="alert">
                    ...
                    <marquee direction="left" style="font-weight: 410;margin-top: 5px;font-size: 14.5px;">
                        <span style="color: #343a40!important"><i class="bx bx-bell bx-tada" style="position: relative; top: 1.5px;"></i> Notification:</span> <span class="badge bg-danger rounded-pill" style="position: relative; top: -1.5px;">1</span> All new requisitions are checked at 10 AM to 11 AM everyday. But you can start a <a style="color: #222;" target="_blank" href="{{ route('get.started') }}">new requisition</a> anytime.
                    </marquee>
