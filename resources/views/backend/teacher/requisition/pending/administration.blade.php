...
@section('title', 'Administration - Pending Requisitions')
...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Administration - Pending Requisitions (<?php echo $pending->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('teacher.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Pending Requisitions(Administration)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5><span class="text-success"><b>Administration - Pending Requisitions (<?php echo $pending->count(); ?>)</b></span></h5> 
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="inline" style="display: flex; gap: 10px;">
                                                    ...
                                                    <form action="{{ route('cancel.requisition') }}" method="post">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{ $data->id }}">
                                                        <button class="btn btn-danger btn-rounded btn-sm delete" onclick="return confirm('Are you sure to cancel this requisition permanently?')" style="margin-left: 5px;" title="Delete" type="submit"><i class="fas fa-trash-alt"></i> Cancel</button> 
                                                    </form>
            ...
            <p style="text-align: center; margin-top: 10px;"><a class="btn btn-primary waves-effect waves-light" href="{{ route('teacher.dashboard') }}"><i class="far fa-arrow-alt-circle-left"></i> Go To Dashboard </a></p>
            <br>
