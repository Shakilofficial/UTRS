...
@section('title', 'Get Started | New Requisition')
                    ...
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <div class="text-muted mt-4" style="text-align: justify;">
                                ...
                                <p><i class="mdi mdi-chevron-right text-primary me-1"></i> <span style="font-weight: 550;">06 Tk/Km + 12 Tk/Hr haltage</span> (Minimum <b style="font-weight: 550;">150 Tk</b>) - <span class="text-primary" style="text-transform: uppercase; font-weight: 550;">Micro Bus/Pickup</span></p>
